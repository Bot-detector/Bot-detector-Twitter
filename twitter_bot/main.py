...
with open(
    os.path.join(os.curdir + r"/pickle-jar/last_tweet.pickle"), "rb"
) as input_file:
    try:
...
if __name__ == "__main__":
    while True:
        Responses = client.get_users_mentions(
            1385386880464822274, max_results=5, since_id=newest_tweet
        )
        ...
        with open(
            os.path.join(os.curdir + r"/pickle-jar/last_tweet.pickle"), "wb"
        ) as output_file:
